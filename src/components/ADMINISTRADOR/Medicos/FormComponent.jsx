...
const FormComponent = ({text}) => {
    ...
    return (
        <>
            ...
            <div className="super-form-container-admin">
                <div className="med-form-container-admin">
                    <h2>{text} Médico</h2>
                    <form className="med-form-admin" onSubmit={handleSubmit}>
                        <div className="fst-inputs-admin">
                        ...
                        <div className="snd-inputs-admin">
                        ...
                        <div className="trd-inputs-admin">
                        ...
                        <div className="fth-inputs-admin">
                        ...
                        <div className="button-class-form-admin">
